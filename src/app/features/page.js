export const metadata = {
  title: 'كيف يعمل ويزازو',
  description: 'شرح سريع لبنية ويزازو، الواجهة الرئيسية، التصنيفات، صفحات المساهمين، وآلية النشر داخل الموقع.',
...
const groups = [
  ...
  },
  {
    ...
    intro: 'يعتمد ويزازو على بنية تسمح باستقبال المقالات من المساهمين ثم مراجعتها قبل النشر.',
    items: [
          ...
          <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr]">
            <div className="space-y-6 text-right">
              ...
              <p className="max-w-3xl text-lg leading-8 text-slate-600">
                بني ويزازو ليعمل كموقع محتوى عربي مرن: الصفحة الرئيسية تقودك إلى الأحدث والأبرز، والتصنيفات توسع التصفح، وصفحات المساهمين تضيف بعداً تحريرياً مستمراً.
              </p>
            </div>
