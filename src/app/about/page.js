export const metadata = {
  title: 'عن أرزابريس',
  description: 'تعرف على هوية أرزابريس، منهجه التحريري، وطبيعة المحتوى الذي يقدمه للقارئ العربي.',
...
const pillars = [
  {
    ...
    text: 'أرزابريس يركز على تقديم الأخبار والمقالات والتحليلات عبر واجهة سهلة وسريعة، بحيث يصل القارئ إلى الموضوع الذي يهمه من دون ازدحام أو تشتيت.',
  },
  {
  ...
  },
  {
    ...
    text: 'نعتبر صفحات الدعم والسياسات جزءاً من تجربة الموقع نفسها، لذلك نعمل على جعلها مرتبطة فعلاً بطريقة عمل أرزابريس وليس كنصوص عامة منفصلة عن المنتج.',
  },
];
...
const sections = [
  {
    eyebrow: 'فكرة الموقع',
    title: 'لماذا تم بناء أرزابريس؟',
    text:
      'الهدف من أرزابريس هو تقديم موقع عربي حديث يوازن بين سرعة الوصول إلى الخبر وبين إمكانية قراءة مواد أعمق وأكثر ترتيباً. لذلك بنيت الصفحة الرئيسية على هيئة مجلة رقمية مرنة، مع إبراز التصنيفات، والمواد المميزة، والمساهمين.',
  },
  {
    eyebrow: 'ماذا نقدم',
    title: 'منصة تحريرية وليست مجرد صفحة أخبار',
    text:
      'يعرض أرزابريس محتوى متنوعاً يشمل الأخبار السريعة، المقالات، التحليلات، التصنيفات المتخصصة، وصفحات المساهمين، مع أدوات إدارية تتيح إضافة المقالات وإدارتها ونشرها بطريقة منظمة.',
  },
  {
    eyebrow: 'كيف نفكر',
        ...
        <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:px-8">
          <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr]">
            <div className="space-y-6 text-right">
              ...
              <h1 className="text-5xl font-black leading-[1.4] text-slate-950 sm:text-6xl">أرزابريس مساحة عربية للأخبار والمقالات والتحليلات المنظمة</h1>
              <p className="max-w-3xl text-lg leading-8 text-slate-600">
                يعرض أرزابريس محتوى تحريري متنوعاً عبر بنية واضحة تساعد القارئ على متابعة الجديد، واكتشاف التصنيفات، والعودة إلى الكتّاب والمساهمين بسهولة.
              </p>
            </div>
