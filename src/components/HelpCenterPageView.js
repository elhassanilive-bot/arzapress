...
const faqSections = [
  {
    ...
    items: [
      { q: 'كيف أنشئ حساباً في ويزازو؟', a: 'يمكنك إنشاء حساب من صفحة التسجيل ثم استخدامه للدخول إلى صفحة الحساب والمساهمة وإدارة الطلبات المرتبطة بك.', k: ['حساب', 'تسجيل', 'دخول'] },
  ...
  },
  {
    ...
    items: [
      { q: 'كيف أرسل مقالاً إلى ويزازو؟', a: 'إذا كان لديك حساب مساهم، يمكنك فتح صفحة المساهمين وتجهيز العنوان والملخص والتصنيف والنص ثم إرسال المادة للمراجعة.', k: ['إرسال مقال', 'مساهم', 'نشر'] },
      ...
      { q: 'هل أحتفظ بحقوق مقالتي بعد النشر؟', a: 'تبقى حقوقك الأصلية على المادة ما لم يوجد اتفاق خاص، لكنك تمنح ويزازو حق عرضها وتنسيقها وتحريرها تحريراً معقولاً داخل المنصة.', k: ['الحقوق', 'المقالة', 'الملكية الفكرية'] },
  ...
  },
  {
    ...
    items: [
      { q: 'هل كل ما ينشر في ويزازو يمثل موقف الموقع؟', a: 'ليس بالضرورة. بعض المواد خبرية، وبعضها تحليلي أو رأي أو مساهمات خارجية، لذلك يجب قراءة نوع المادة وسياقها قبل نسبة الموقف للموقع ككل.', k: ['موقف الموقع', 'رأي', 'تحرير'] },
      ...
      { q: 'هل ينشر ويزازو آراء ومساهمات خارجية؟', a: 'نعم، لكن نشرها يتم ضمن مراجعة تحريرية، ولا يعني ذلك تبني كل ما يرد فيها كموقف رسمي نهائي للموقع.', k: ['آراء', 'مساهمات', 'خارجية'] },
    ],
  },
  {
    id: 'legal',
    ...
    items: [
      ...
      { q: 'ما المقصود بصفحة إخلاء المسؤولية؟', a: 'هي الصفحة التي توضح أن محتوى ويزازو مخصص للإطلاع العام ولا يغني عن الاستشارة المهنية أو القانونية أو الطبية أو المالية المتخصصة.', k: ['إخلاء المسؤولية', 'استشارة', 'اعتماد'] },
      ...
      { q: 'هل يبيع الموقع بيانات المستخدمين؟', a: 'لا. ويزازو لا يبيع البيانات الشخصية للمستخدمين، ويقصر أي مشاركة على ما يلزم للتشغيل أو الحماية أو الالتزام القانوني.', k: ['بيع البيانات', 'البيانات الشخصية', 'مشاركة'] },
        ...
        <section className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm sm:p-10">
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-3xl text-lg leading-8 text-slate-600">
              صفحة شاملة لأسئلة ويزازو: الحساب، التصفح، المساهمون، السياسة التحريرية، الخصوصية، حقوق النشر، والأعطال التقنية.
            </p>
          </div>
